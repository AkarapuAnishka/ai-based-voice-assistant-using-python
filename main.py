        ...
        try:
            ...
            if 'lisa' in command:
                ...
                if 'hello' in command:
                    ...
                    engine_talk('hello anishka, how can i help you ??')
                elif 'who are you' in command:
                    print('I am lisa a k a your voice assistant ')
                    engine_talk('I am lisa , your voice assistant . how can i help you ??')

                elif 'can you do' in command:
                    print('''i can play songs on youtube , tell you a joke, capture a photo through camera, take a screenshot, search on wikipedia, tell date and time,find your location, locate area on map,
                      open different websites like  instagram, youtube,gmail, git hub, stack overflow and searches on google.How may i help you ??''')
                    engine_talk('''i can play songs on youtube , tell you a joke,capture a photo through camera, take a screenshot, search on wikipedia, tell date and time,find your location, locate area on map,
                      open different websites like  instagram, youtube,gmail, git hub, stack overflow and searches on google. How may i help you ??''')
            ...
            print('\n')
            print("hello, i am lisa how can i help you ??")
            engine_talk("hello i am lisa how can i help you ")
